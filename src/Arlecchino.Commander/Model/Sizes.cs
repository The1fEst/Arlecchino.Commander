...
public static class Sizes
{
    ...
    ///     and stands apart from the number rather than being shortened to fit a cell budget.
    /// </summary>
    ...
    ///     by different means and neither says it in words, so the words are here.
    /// </summary>
    ...
    ///     yesterday, a day and a month for this year, and the year as well for anything older.
    /// </summary>
