...
/// <summary>
/// Two panels and which of them is being worked in, which is one tab's worth of the application. A
/// connection opens a session of its own and is closed whole when the server is done with.
/// </summary>
