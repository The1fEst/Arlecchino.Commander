...
///     The layout goes in here rather than at the one place the application is started from. There are three
///     of those: the application, the headless frame a screenshot is taken from, and the test host. A screen
///     that wears the band in front of a person and not under test is worse than no test at all.
/// </summary>
