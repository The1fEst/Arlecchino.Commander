...
///     It is drawn on the lit surface, and the room left between the name and the hint goes to
///     <see cref="TabStrip" />.
/// </summary>
public sealed class Banner
{
    ...
    ///     inside an inset strip, so the two are put in the same coordinates first.
    /// </summary>
